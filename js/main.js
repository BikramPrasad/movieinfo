$(document).ready(() => {
        ...
        $.each(movies,(index,movie) =>{
            output += `
             <div class="col-md -3">
                ...
                <h5>${movie.Title}</h5>
                <a onlclick="movieSelected('${movie.imdbID}')" class="btn btn-primary" href="#">Movie Details</a>
                </div>
                </div>
                `;
             });
 ...
 function getMovie(){
     ...
     axios.get('http://www.omdbapi.com?apikey=5f069f9b&i='+movieId)
     .then((x) => {
         console.log(x);
         let movie=x.data;
